...
<body>
	...
	request.setCharacterEncoding("UTF-8");
		...
		Account18 ac18 = (Account18)session.getAttribute("input_data");
	%>
		<p style="color:red">登録に失敗しました。</p>
		<h3>新規会員登録</h3>
		<form action="RegisterConfirmServlet" method="post">
			メール：<input type="email" name="email" value="<%=ac18.getMail()%>"><br>
			パスワード：<input type="password" name="pw"><br>
			名前：<input type="text" name="name" value="<%=ac18.getName()%>"><br>
			学年：<input type="number" name="grade" value="<%=ac18.getGrade()%>"><br>
			学科：<br>
